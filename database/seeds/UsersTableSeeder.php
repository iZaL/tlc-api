...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $driverUser = factory(\App\Models\User::class)->create(['email' => 'driver@test.com', 'password' => bcrypt('password'), 'active' => 1]);
        $customer1 = factory(\App\Models\User::class)->create(['email' => 'customer@test.com', 'password' => bcrypt('password'), 'active' => 1]);
